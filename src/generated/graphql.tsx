...
export type Unnamed_1_Query = (
  ...
  & { getAllUsers?: Maybe<Array<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'firstName' | 'lastName' | 'name' | 'email' | 'isActive'>
  )>> }
);
...
export type LoginMutation = (
  ...
  & { login?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'firstName' | 'lastName' | 'email' | 'name' | 'isActive'>
  )> }
);
...
export const UpdateUserDocument = gql`
    mutation UpdateUser($id: Float!, $lastName: String!, $firstName: String!, $email: String!) {
  updateUser(id: $id, lastName: $lastName, firstName: $firstName, email: $email)
}
    `;
